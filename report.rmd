...
## rename variables for easy access and convert category variables to factors
```{r}
...
## generate a matrix of scatterplots of numeric variables
```{r}
...
- colinearity
  ...
  - `thinness_1_19` and `thinness_5_9`
...
### remove linearly correlated column and two category columns
```{r}
...
#### a smaller model with predictors with `p-value < 0.01`
```{r}
...
### meeting notes: compare additive with interaction also
